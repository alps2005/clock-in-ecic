...
export function Login() {
  ...
  return <div className="welcome">
    ...
    <main id="main" tabIndex={-1}>
      <section className="intro"><p className="eyebrow"><span /> PRESENTES, CADA DÍA</p><h1>Cada día<br />cuenta<span className="accent">.</span></h1><p className="intro-copy">Tu jornada, tu asistencia.<br />Un espacio para nuestra comunidad docente.</p><div className="preparation-note"><span className="note-icon" aria-hidden="true">↗</span><div><h2>Tiempo para enseñar. Espacio para crecer.</h2><p>Registra tu entrada y salida, y consulta tu historial en un solo lugar.</p></div></div></section>
      <section className="login-card" aria-labelledby="login-title"><span className="card-eyebrow">BIENVENIDO A TU ESPACIO</span><h2 id="login-title">Inicia tu jornada.</h2><p>Ingresa con los datos de tu cuenta institucional.</p>
        ...
        <form onSubmit={submit}>
          ...
          <button className="button primary login-submit" disabled={pending || !config.ready}>{pending ? 'Ingresando…' : 'Ingresar'}<span aria-hidden="true">↗</span></button>

...
export type AdminNotification = { id: string; teacher_id: string; full_name: string; cedula: string; school_date: string; entry_at: string | null; kind: 'entry' | 'exit'; read_at: string | null; expires_at: string | null; entry_closes: string; exit_closes: string }
export type Notifications = { total: number; unread: number; rows: AdminNotification[] }
